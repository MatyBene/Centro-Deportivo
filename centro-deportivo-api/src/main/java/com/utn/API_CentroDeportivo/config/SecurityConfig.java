    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/routines/**").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/v1/routines/**").authenticated()
                        .requestMatchers(HttpMethod.PUT, "/api/v1/routines/**").authenticated()
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/routines/**").authenticated()
                        .requestMatchers("/api/v1/routineAssignments/**")
                        .hasAnyRole("INSTRUCTOR", "MEMBER", "ADMIN")
                        .requestMatchers("/api/v1/trainingHistory/**").authenticated()
